...
<form action="{{ url("/task/$task->id_task") }}" method="post">
    ...
    <div class="modal-content" style="background-color: #f7f2ed; border: 2px solid #6e4823; border-radius: 10px; padding: 20px; margin: 20px;">
        <div class="modal-header" style="border-bottom: 1px solid #6e4823; margin-bottom:15px;">
            <h1 class="modal-title fs-5" id="exampleModalLabel" style="color: #6e4823; margin-bottom:25px;">Add Project</h1>
        </div>
        <div class="modal-body">
            <div class="mb-3">
                <label for="nama" class="form-label" style="color: #6e4823;">Name</label>
                <input type="text" class="form-control" id="nama" name="nama" value="{{ $task->nama }}" style="border: 1px solid #6e4823;">
            </div>
            <div class="mb-3">
                <label for="status" class="form-label" style="color: #6e4823;">Status</label>
                <select name="status" class="form-select" style="border: 1px solid #6e4823;">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="tanggal" name="tanggal" value="{{ $task->tanggal }}" style="border: 1px solid #6e4823;">
            </div>
            <div class="mb-3">
